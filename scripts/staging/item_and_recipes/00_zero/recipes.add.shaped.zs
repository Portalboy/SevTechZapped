...
var shapedRecipes as IIngredient[][][][IItemStack] = {
	...
	//This is the wooden gear
		[
			[<primal:shark_tooth>, <minecraft:planks>, <primal:shark_tooth>],
	...
	<beneath:teleporterbeneath> : [
		[
			[<minecraft:dark_oak_fence_gate>, <ceramics:clay_hard>, <minecraft:leather>],
			[<ceramics:clay_hard>, <progressiontweaks:blank_teleporter>, <ceramics:clay_hard>],
			[<betterwithmods:material:18>, <ceramics:clay_hard>, <minecraft:gunpowder>]
		]
	],
